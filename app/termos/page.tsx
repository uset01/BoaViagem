...
// TODO: substituir pelo texto real dos Termos de Uso antes de lançar pra
// usuários de verdade — não inventar cláusulas legais aqui.
  ...
  return (
    <div className="flex min-h-screen flex-col bg-bg px-5 pb-10" style={{ paddingTop: "env(safe-area-inset-top)" }}>
      ...
      <header className="mt-4 space-y-1">
        ...
        <h1 className="text-xl font-extrabold text-ink">Termos de uso</h1>
      </header>

      <p className="mt-5 text-sm leading-relaxed text-ink-secondary">
        Este texto ainda não foi escrito. Assim que os termos de uso estiverem definidos, eles serão publicados
        aqui.
      </p>
    </div>
  );
